...
export default function Card({ index, bgImg, title, btnText }: CardProps) {
  return (
    <div
      className={`relative flex xl:bg-[#171B4180] lg:h-[20rem] rounded-[1rem] overflow-hidden lg:w-[29rem] items-center justify-center mb-[1rem] sm:mr-[2rem] bg-women`}
    >
      <div className='absolute hidden lg:block h-[100%] w-[100%] z-[-1]'>
