...
export default function Footer() {
  return (
    <footer
      ...
      className='mt-[5rem] bg-[#252641] pt-[3rem] pb-[1.5rem]'
    >
      <Padding>
        <div className='flex flex-col items-center'>
          ...
          <form className='mt-[4rem] flex flex-col items-center' action=''>
            ...
            <div className='flex flex-col'>
              <input
                className='px-[0.5rem] py-[0.5rem] rounded-[2rem] placeholder:text-[#83839A] border-[1px] border-solid text-center border-[#83839A] bg-transparent focus:bg-white'
                type='email'
              ...
              <button
                type='submit'
                className='mt-[1rem] py-[0.5rem] rounded-[2rem] text-[#FFFFFF] bg-gradient-to-r from-blue-500 to-indigo-800 hover:scale-[1.02] active:scale-[0.99] duration-[0.3s] hover:bg-gradient-to-l hover:from-blue-500 hover:to-indigo-800'
              >
                Subscribe
              </button>
            </div>
