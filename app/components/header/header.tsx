...
export default function Header() {
  return (
    <div className='relative min-[1488px]:flex min-[1488px]:justify-center'>
      <Image
        className='h-[95vh] min-[1488px]:h-[40rem] min-[1488px]:w-[100%] absolute z-[-2]'
        src={Bg}
        alt=''
      />
      <div className='w-full min-[1488px]:w-[70rem]'>
        <Padding>
          <div className='flex flex-col lg:flex-row lg:items-center lg:justify-between lg:h-[100vh] min-[1488px]:h-[45rem]'>
            <div className='w-[50%]'>
            ...
            <div className='mr-[10rem] min-[1488px]:mr-[2rem] relative '>
