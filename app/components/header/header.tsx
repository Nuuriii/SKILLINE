      ...
      <div className='w-full bg-[#FFF2E1] lg:bg-transparent min-[1488px]:w-[70rem]'>
        <Padding>
          <div className='flex justify-center'>
            <div className='flex pt-[4rem] lg:pt-0 flex-col items-center justify-center lg:flex-row lg:items-center lg:justify-between  h-[100vh] md:h-[42rem] lg:h-[100vh] min-[1488px]:h-[45rem] min-[500px]:w-[30rem] lg:w-full'>
              ...
              <div className='w-[100%] mt-[3rem] md:mt-[0]  lg:w-[50%]'>
                ...
                <div className='flex items-center justify-center lg:justify-start'>
                  ...
                  <p className='text-[#252641] hidden lg:flex'>
                    Watch how it works
                  </p>
                </div>
              </div>
